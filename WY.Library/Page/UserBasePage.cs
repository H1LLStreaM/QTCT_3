...
namespace WY.Library.Page
{
    public class UserBasePage : System.Web.UI.Page
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            //检查是否登录
            //if (SessionManager.Memberid <= 0)
            //{
            //    Context.Response.Redirect("/index/login.aspx?page=" + Server.UrlEncode(Request.Url.AbsoluteUri));
            //    return;
            //}

            //if (!this.CheckUserpower())
            //{
            //    Context.Response.Redirect("/index/login.aspx");
            //    return;
            //}
